...
# منحنی استاندارد Volt-VAr طبق IEEE 1547-2018 (نقاط V1-V4 و Q1-Q4)
V1, V2, V3, V4 = 0.92, 0.98, 1.02, 1.08
Q1, Q2, Q3, Q4 = 0.44, 0.0, 0.0, -0.44

def volt_var_q(voltage_pu, inverter_kva):
    """محاسبه توان راکتیو بر اساس ولتاژ فعلی، طبق منحنی Volt-VAr"""
    if voltage_pu <= V1:
        q_ratio = Q1
    elif voltage_pu <= V2:
...
for bus in load_buses:
    ...
    while pv_kw < MAX_KW:
        ...
        for _ in range(10):
            ...
            q_new_kvar = volt_var_q(v_bus, pv_kw)
...
print("\n=== مقایسه Baseline در برابر Volt-VAr ===")
